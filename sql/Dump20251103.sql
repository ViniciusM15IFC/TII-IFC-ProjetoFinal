...
CREATE TABLE `classificacao` (
  ...
  `nomeclassificacao` varchar(45) DEFAULT NULL,
...
INSERT INTO `conteudo` VALUES (3,2),(3,3),(4,1),(4,2),(5,1),(6,1);
...
CREATE TABLE `filme` (
  ...
  `idgenero` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `postagem` (
  ...
  `datapostagem` varchar(45) DEFAULT NULL,
...
INSERT INTO `postagem` VALUES (1,3,1,9,'a','9','2025-10-20 09:08:14'),(2,5,1,8,'alice','9','2025-10-20 09:22:05'),(3,3,1,10,'tendi nada','6','2025-10-20 09:23:56'),(4,2,3,10,'cara só sofre','6','2025-10-20 09:24:50'),(5,2,2,10,'mentira da isabella','6','2025-10-20 09:28:35'),(6,3,1,1,'muito ruim #supermerda','5','2025-10-20 09:37:14'),(7,2,2,10,'Melhor Série do Universo, quem critica não entende nada de cultura e é bobão cara de mamão','10','2025-10-30 14:30:44'),(8,3,2,2,'8=================D','10','2025-10-30 14:34:37'),(9,4,1,1,'esses olos feios da capa cruzes cersdo coisa mais f er9i\\as demitam a mae desse fotografo por nao ter abortado eled','1','2025-10-30 14:41:32'),(10,2,2,1,'agora UM MICO esse site do governo','1','2025-10-30 14:42:58');
...
INSERT INTO `seguido` VALUES (1,9),(3,9),(3,10),(6,9),(7,1),(9,1),(9,10),(10,9);
...
CREATE TABLE `sugestao` (
  ...
  `nomesugestao` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2025-11-03  8:41:34
